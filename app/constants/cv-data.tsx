const CV_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      github: "",
      description:
        "A multi-page Korean cosmetics website based on the Next.js and a simple Node.js Express server. Created according to the layout of the designer. A self-written admin panel for updating content.",
      screenshot: "/project-screenshots/hankook-cosmetics.jpg",
      isScreenshootDark: false,
      team: false,
      tech: ["NEXTJS", "TS", "REACT"],
    },
    {
      name: "GRAPHIQL",
